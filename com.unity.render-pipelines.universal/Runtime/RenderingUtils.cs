...
{
    /// <summary>
    /// Contains properties and functions to help performing rendering work.
    /// </summary>
    [MovedFrom("UnityEngine.Rendering.LWRP")] public static class RenderingUtils
    {
        ...
        /// <summary>
        /// Returns a mesh that can be used with <see cref="CommandBuffer.DrawMesh(Mesh, Matrix4x4, Material)"/> to render full screen effects.
        /// </summary>
        ...
        /// <summary>
        /// Checks if a render texture format is supported by the runtime system.
        /// Similar to <see cref="SystemInfo.SupportsRenderTextureFormat(RenderTextureFormat)"/> but doesn't allocate memory.
        /// </summary>
        /// <param name="format">The format to look up.</param>
        /// <returns>Returns true if graphics card supports given <c>RenderTextureFormat</c></returns>
