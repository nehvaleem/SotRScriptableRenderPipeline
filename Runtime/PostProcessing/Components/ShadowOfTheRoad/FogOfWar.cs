...
namespace UnityEngine.Rendering.HighDefinition
{
    ...
    {
        public ColorParameter fogColor = new ColorParameter(new Color(0,0,0,1), false, true, true);
        public TextureParameter map = new TextureParameter(null);
        public ColorParameter mapTint = new ColorParameter(new Color(0,0,0,1), false, true, true);
